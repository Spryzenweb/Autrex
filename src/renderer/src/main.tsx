...
import { getThemeById, defaultTheme, defaultDarkTheme } from './themes/themes'
import { applyTheme } from './themes/utils'

// Apply initial theme based on stored preference or system preference
const storedConfig = localStorage.getItem('autrex-theme-config')
...
if (storedConfig) {
  try {
    ...
    initialTheme = getThemeById(themeId) || (isDark ? defaultDarkTheme : defaultTheme)
  } catch {
    // Use default
  }
} else {
