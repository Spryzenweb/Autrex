...
function generateLicenseKey(type: LicenseType = LicenseType.REGULAR): string {
...
function formatLicenseKey(productCode: string, uniqueId: string, checksum: string): string {
...
function generateBatch(count: number, type: LicenseType): string[] {
