# Adding a New Language to Autrex

This guide explains how to add a new language to the Autrex application, covering both UI translations and champion data localization.

## Overview

Autrex uses [i18next](https://www.i18next.com/) for internationalization and supports multiple languages for:
